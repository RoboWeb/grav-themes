...
return [
    ...
    'filename' => 'C:/xampp/htdocs/_www_czyscimy/user/plugins/relatedpages/languages.yaml',
    'modified' => 1547056377,
    'data' => [
        'en' => [
            'PLUGIN_REL_PAGES' => [
        ...
        'pl' => [
            'PLUGIN_REL_PAGES' => [
                ...
                'LIMIT' => 'Limit',
                'LIMIT_HELP' => 'Liczba powiązanych ze sobą stron do wyświetlenia',
                'ORDER' => 'Uporządkowanie',
                'ORDER_BY' => 'Ordery by',
                'SHOW_SCORE' => 'Pokaż punktację',
                'SHOW_SCORE_HELP' => 'Przełącz, aby określić, czy wyniki powinny być wyświetlane na wyjściu',
                'ITEMS' => 'Pozycje',
                'ITEMS_HELP' => 'Wspierane kolekcje oparte na `@self`, `@page`, i `@taxonomy`',
                'PAGE_IN_FILTER' => 'Filtr \'in\' strony',
                'PAGE_IN_FILTER_HELP' => 'Włącz, jeśli chcesz by bieżąca strona znajdowała się w przefiltrowanej kolekcji',
                'EXPLICIT_PROCESS' => 'Weź pod uwagę wskazane strony',
                'EXPLICIT_PROCESS_HELP' => 'Włącz, jeśli chcesz samodzielne wskazać strony powiązane',
                'EXPLICIT_SCORE' => 'Punktacja stron powiązanych',
                'EXPLICIT_SCORE_HELP' => 'Punktacja (0 - 100) pokazuje szacunkową wagę stopnia powiązania stron',
                'TAXONOMY_MATCH' => 'Dopasowanie poprzez taksonomię',
                'TAXONOMY' => 'Taksonomia',
                'TAXONOMY_HELP' => 'Który typ taksonomii jest używany do dopasowywania stron, obsługuje ciągi lub tablicę YAML z wieloma typami taksonomii',
                'TAXONOMY_TAXONOMY_PROCESS' => 'Taxonomy-taxonomy',
                'TAXONOMY_TAXONOMY_PROCESS_HELP' => 'Uruchom taksonomię do dopasowania przez taksonomie',
                'TAXONOMY_CONTENT_PROCESS' => 'Taxonomy-content',
                'TAXONOMY_CONTENT_PROCESS_HELP' => 'Uruchom taksonomie do dopasowania treści',
                'CONTENT_MATCH' => 'Content Type Matching',
                'CONTENT_PROCESS' => 'Content-content',
                'CONTENT_PROCESS_HELP' => 'Enable content to content matching (NOTE: Disable if you have lots of content)',
                'ADVANCED' => 'Advanced',
